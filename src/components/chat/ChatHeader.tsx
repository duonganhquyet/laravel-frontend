  ...
  return (
    <div className="h-[72px] border-b border-white/40 glass-panel flex items-center justify-between px-6 z-10 sticky top-0">
      ...
      <div className="flex items-center gap-1.5">
        {isGroup && (
          <>
            <button onClick={onOpenAddMember} className="p-2.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-full transition-all" title="Thêm thành viên">
